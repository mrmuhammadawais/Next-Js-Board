...
//               <Breadcrumb.Item
//                 style={{
//                   color: darkMode ? "!important #3C50E0" : "!important #3C50E0",
//                 }}
//               >
//                 Profile
//               </Breadcrumb.Item>
...
//         >
//           <div
//             className="relative w-full h-52 bg-cover bg-center rounded-t-lg !p-0"
//             style={{
//               backgroundImage: `url(${
...
//             >
//               <Button className="absolute bottom-2 right-[-3px] sm:right-4 bg-[#3c50e0] text-sm font-small text-white rounded-sm mr-[-2px] w-[83px] h-[23px]">
//                 <CameraOutlined />
//                 Edit
//               </Button>
...
//           <div className="mx-auto mb-5.5 mt-2 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F] w-[380px] p-[9px]">
...
const Profile = () => {
        ...
        >
          ...
          >
            <Upload
              ...
              disabled={isCoverUploading}
            >
              <Button className="absolute bottom-2 right-2 sm:right-4 bg-[#3c50e0] text-sm font-small text-white rounded-sm w-[83px] h-[23px]">
                <CameraOutlined />
                Edit
              </Button>
            </Upload>
          ...
          <div className="mt-2">
            <Text className="text-center" style={{ color: darkMode ? "#ffffff" : "#000000" }}>
              {profile.profession}
            </Text>
          </div>

          <div className="mx-auto mb-5.5 mt-2 grid max-w-94 grid-cols-1 sm:grid-cols-3 gap-4 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F] w-full p-4 sm:w-[380px]">
  <div className="flex flex-col items-center justify-center gap-1 sm:gap-2 sm:flex-row sm:border-r border-stroke px-4 dark:border-strokedark">
    <span
      className="font-bold text-black dark:text-white"
      style={{ color: darkMode ? "#fff" : "#1c2434" }}
    >
  ...
  <div className="flex flex-col items-center justify-center gap-1 sm:gap-2 sm:flex-row px-4">
    <span
      className="font-bold text-black dark:text-white"
      style={{ color: darkMode ? "#fff" : "#1c2434" }}
    >
